...
import { Patcher, PatcherRepository } from './services/patcher';
...
export class ApollonEditor {
    ...
    constructor(container, options) {
        ...
        this.onDispatch = () => {
            ...
            const umlAssessments = Object.keys(assessments).map((id) => ({
                modelElementId: id,
     ...
     */
    remoteSelect(selectorName, selectorColor, select, deselect) {
        this.store?.dispatch(UMLElementRepository.remoteSelectDeselect({ name: selectorName, color: selectorColor }, select, deselect || []));
    }
    /**
