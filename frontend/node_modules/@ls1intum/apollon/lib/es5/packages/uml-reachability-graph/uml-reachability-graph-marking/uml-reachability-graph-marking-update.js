...
exports.UMLReachabilityGraphMarkingUpdate = void 0;
...
var UmlReachabilityGraphMarkingUpdate = /** @class */ (function (_super) {
    tslib_1.__extends(UmlReachabilityGraphMarkingUpdate, _super);
    function UmlReachabilityGraphMarkingUpdate() {
        ...
        _this.toggleIsInitialMarking = function (id) { return function (event) {
            _this.props.update(id, { isInitialMarking: event.currentTarget.checked });
        }; };
    ...
    UmlReachabilityGraphMarkingUpdate.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("section", null,
                react_1.default.createElement("label", { htmlFor: "toggleIsInitialMarking" },
                    react_1.default.createElement("input", { id: "toggleIsInitialMarking", type: "checkbox", checked: element.isInitialMarking, onChange: this.toggleIsInitialMarking(element.id) }),
                    this.props.translate('packages.ReachabilityGraph.ReachabilityGraphIsInitialMarking')))));
    };
    return UmlReachabilityGraphMarkingUpdate;
}(react_1.Component));
exports.UMLReachabilityGraphMarkingUpdate = enhance(UmlReachabilityGraphMarkingUpdate);
