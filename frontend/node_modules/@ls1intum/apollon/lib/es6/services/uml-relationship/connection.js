import { getPortsForElement } from '../uml-element/uml-element';
...
export class Connection {
    static computePath(source, target, options) {
        ...
        while (true) {
            const startAndEndPointCanBeConnected = !lineSegmentIntersectsRect(currentStartPoint, currentEndPoint, sourceMarginRect1px) &&
    ...
    static tryFindStraightPath(source, target) {
        ...
        /*
            ...
            #######                                   #######
        */
        if (sourceHandleEdge === Direction.Right &&
        ...
        /*
            ...
            #######                                   #######
        */
        if (sourceHandleEdge === Direction.Left &&
        ...
        /*
            ...
            ##################
        */
        if (sourceHandleEdge === Direction.Down &&
        ...
        /*
            ...
            ##################
        */
        if (sourceHandleEdge === Direction.Up &&
