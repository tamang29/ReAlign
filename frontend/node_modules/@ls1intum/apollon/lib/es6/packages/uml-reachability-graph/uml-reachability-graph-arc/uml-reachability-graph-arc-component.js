...
export const UMLReachabilityGraphArcComponent = ({ element }) => {
    ...
    return (React.createElement("g", null,
        ...
        React.createElement("text", { x: position.x, y: position.y, ...layoutText(direction), pointerEvents: "none", style: { ...textColor } }, element.name)));
};
