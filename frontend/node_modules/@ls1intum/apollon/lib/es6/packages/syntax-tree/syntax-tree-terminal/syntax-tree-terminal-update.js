...
`;
class SyntaxTreeTerminalUpdateComponent extends Component {
    constructor() {
        super(...arguments);
        ...
        return (React.createElement("div", null,
            React.createElement("section", null,
                React.createElement(Flex, null,
                    React.createElement(Textfield, { value: element.name, placeholder: this.props.translate('packages.SyntaxTree.SyntaxTreeTerminal'), onChange: this.onUpdate, autoFocus: true }),
...
export const SyntaxTreeTerminalUpdate = enhance(SyntaxTreeTerminalUpdateComponent);
