...
exports.UMLUseCaseExtendComponent = void 0;
...
var Arrow = function (_a) {
    ...
    return (react_1.default.createElement("g", null,
        ...
        react_1.default.createElement(themedComponents_1.ThemedPath, { d: d, strokeDasharray: 7, markerEnd: "url(#marker-".concat(id, ")"), strokeColor: color })));
};
var UMLUseCaseExtendComponent = function (_a) {
    ...
    return (react_1.default.createElement("g", null,
        ...
        react_1.default.createElement(text_1.Text, { noX: true, noY: true, fill: element.textColor, transform: norm.x < 0
                ...
                : undefined },
            react_1.default.createElement("textPath", { xlinkHref: "#textpath-".concat(element.id), startOffset: "50%" }, "\u00ABextend\u00BB"))));
};
exports.UMLUseCaseExtendComponent = UMLUseCaseExtendComponent;
