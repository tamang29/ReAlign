...
export declare const UMLRelationships: {
    ClassAggregation: typeof UMLClassAggregation;
    ClassBidirectional: typeof UMLClassBidirectional;
    ClassComposition: typeof UMLClassComposition;
    ClassDependency: typeof UMLClassDependency;
    ClassInheritance: typeof UMLClassInheritance;
    ClassRealization: typeof UMLClassRealization;
    ClassUnidirectional: typeof UMLClassUnidirectional;
    ObjectLink: typeof UMLObjectLink;
    ActivityControlFlow: typeof UMLActivityControlFlow;
    UseCaseAssociation: typeof UMLUseCaseAssociation;
    UseCaseExtend: typeof UMLUseCaseExtend;
    UseCaseGeneralization: typeof UMLUseCaseGeneralization;
    UseCaseInclude: typeof UMLUseCaseInclude;
    CommunicationLink: typeof UMLCommunicationLink;
    ComponentDependency: typeof UMLComponentDependency;
    ComponentInterfaceProvided: typeof UMLComponentInterfaceProvided;
    ComponentInterfaceRequired: typeof UMLComponentInterfaceRequired;
    DeploymentAssociation: typeof UMLDeploymentAssociation;
    DeploymentDependency: typeof UMLDeploymentDependency;
    DeploymentInterfaceProvided: typeof UMLDeploymentInterfaceProvided;
    DeploymentInterfaceRequired: typeof UMLDeploymentInterfaceRequired;
    PetriNetArc: typeof UMLPetriNetArc;
    ReachabilityGraphArc: typeof UMLReachabilityGraphArc;
    SyntaxTreeLink: typeof SyntaxTreeLink;
    FlowchartFlowline: typeof FlowchartFlowline;
    BPMNFlow: typeof BPMNFlow;
};
