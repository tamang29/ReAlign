...
export type AsyncDispatch<TActionCreator extends (...args: any[]) => ThunkAction<any, any, any, any>> = (...args: Parameters<TActionCreator>) => ReturnType<ReturnType<TActionCreator>>;
declare module 'redux-saga/effects' {
    function put<A extends Action>(action: A | AsyncAction): PutEffect<A>;
}
