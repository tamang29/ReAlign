...
exports.BPMNGatewayUpdate = void 0;
...
var BPMNGatewayUpdateComponent = /** @class */ (function (_super) {
    tslib_1.__extends(BPMNGatewayUpdateComponent, _super);
    function BPMNGatewayUpdateComponent() {
         ...
         */
        _this.changeGatewayType = function (id) { return function (value) {
            _this.props.update(id, { gatewayType: value });
        }; };
        /**
         * Delete a gateway
    ...
    BPMNGatewayUpdateComponent.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("section", null,
                react_1.default.createElement(dropdown_1.Dropdown, { value: element.gatewayType, onChange: this.changeGatewayType(element.id) },
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'exclusive' }, this.props.translate('packages.BPMN.BPMNExclusiveGateway')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'parallel' }, this.props.translate('packages.BPMN.BPMNParallelGateway')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'inclusive' }, this.props.translate('packages.BPMN.BPMNInclusiveGateway')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'event-based' }, this.props.translate('packages.BPMN.BPMNEventBasedGateway')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'complex' }, this.props.translate('packages.BPMN.BPMNComplexGateway'))))));
    };
    return BPMNGatewayUpdateComponent;
}(react_1.Component));
exports.BPMNGatewayUpdate = enhance(BPMNGatewayUpdateComponent);
