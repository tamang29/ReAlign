...
exports.SyntaxTreeNonterminalUpdate = void 0;
...
var SyntaxTreeNonterminalUpdateComponent = /** @class */ (function (_super) {
    tslib_1.__extends(SyntaxTreeNonterminalUpdateComponent, _super);
    function SyntaxTreeNonterminalUpdateComponent() {
    ...
    SyntaxTreeNonterminalUpdateComponent.prototype.render = function () {
        var _this = this;
        var element = this.props.element;
        return (react_1.default.createElement("div", null,
            react_1.default.createElement("section", null,
                react_1.default.createElement(Flex, null,
                    react_1.default.createElement(textfield_1.Textfield, { value: element.name, placeholder: this.props.translate('packages.SyntaxTree.SyntaxTreeNonterminal'), onChange: this.onUpdate, autoFocus: true }),
    ...
    return SyntaxTreeNonterminalUpdateComponent;
}(react_1.Component));
...
exports.SyntaxTreeNonterminalUpdate = enhance(SyntaxTreeNonterminalUpdateComponent);
var templateObject_1;
//# sourceMappingURL=syntax-tree-nonterminal-update.js.map