...
export type Actions = EditorActions | LayouterActions | PatcherActions | UMLContainerActions | UMLElementActions | UMLRelationshipActions | UMLDiagramActions | ConnectableActions | ReconnectableActions | HoverableActions | InteractableActions | MovableActions | MovingActions | ResizableActions | ResizingActions | SelectableActions | RemoteSelectionActions | UpdatableActions | AssessmentActions | UndoActions | CopyActions;
