...
var BPMNFlowUpdateComponent = /** @class */ (function (_super) {
    tslib_1.__extends(BPMNFlowUpdateComponent, _super);
    function BPMNFlowUpdateComponent() {
         ...
         */
        _this.changeFlowType = function (id) { return function (value) {
            _this.props.update(id, { flowType: value });
        }; };
    ...
    BPMNFlowUpdateComponent.prototype.render = function () {
        var _this = this;
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("section", null,
                react_1.default.createElement(dropdown_1.Dropdown, { value: element.flowType, onChange: this.changeFlowType(element.id) },
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'sequence' }, this.props.translate('packages.BPMN.BPMNSequenceFlow')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'message' }, this.props.translate('packages.BPMN.BPMNMessageFlow')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'association' }, this.props.translate('packages.BPMN.BPMNAssociationFlow')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'data association' }, this.props.translate('packages.BPMN.BPMNDataAssociationFlow')))),
    ...
    return BPMNFlowUpdateComponent;
}(react_1.Component));
exports.BPMNFlowUpdate = enhance(BPMNFlowUpdateComponent);
