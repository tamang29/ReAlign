    ...
    render() {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("section", null,
                ...
                React.createElement(Textfield, { ref: this.newAttributeField, outline: true, value: "", onSubmit: this.create(UMLObjectAttribute), onSubmitKeyUp: (key, value) => {
            ...
            React.createElement("section", null,
                ...
                React.createElement(Textfield, { ref: this.newMethodField, outline: true, value: "", onSubmit: this.create(UMLObjectMethod), onSubmitKeyUp: () => this.setState({
                        fieldToFocus: this.newMethodField.current,
                    }), onKeyDown: (event) => {
                        // workaround when 'tab' key is pressed:
                        // prevent default and execute blur manually without switching to next tab index
