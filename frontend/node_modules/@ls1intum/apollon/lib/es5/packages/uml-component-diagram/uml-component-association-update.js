...
exports.UMLComponentAssociationUpdate = void 0;
...
var ComponentAssociationUpdate = /** @class */ (function (_super) {
    tslib_1.__extends(ComponentAssociationUpdate, _super);
    function ComponentAssociationUpdate() {
    ...
    ComponentAssociationUpdate.prototype.render = function () {
        var _this = this;
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("section", null,
                react_1.default.createElement(dropdown_1.Dropdown, { value: element.type, onChange: this.onChange },
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: _1.ComponentRelationshipType.ComponentDependency }, this.props.translate('packages.ComponentDiagram.ComponentDependency')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: _1.ComponentRelationshipType.ComponentInterfaceProvided }, this.props.translate('packages.ComponentDiagram.ComponentInterfaceProvided')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: _1.ComponentRelationshipType.ComponentInterfaceRequired }, this.props.translate('packages.ComponentDiagram.ComponentInterfaceRequired'))))));
    };
    return ComponentAssociationUpdate;
}(react_1.Component));
...
exports.UMLComponentAssociationUpdate = enhance(ComponentAssociationUpdate);
