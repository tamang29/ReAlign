...
import { areBoundsIntersecting } from '../../utils/geometry/boundary';
...
class MouseEventListenerComponent extends Component {
    constructor(props) {
        super(props);
        /**
    ...
    render() {
        ...
        return (this.state.selectionStarted &&
            width != 0 && (React.createElement("svg", { opacity: 0.5, pointerEvents: 'none', style: {
                position: 'fixed',
