...
exports.BPMNEndEventUpdate = void 0;
...
var BPMNEndEventUpdateComponent = /** @class */ (function (_super) {
    tslib_1.__extends(BPMNEndEventUpdateComponent, _super);
    function BPMNEndEventUpdateComponent() {
    ...
    BPMNEndEventUpdateComponent.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("section", null,
                ...
                react_1.default.createElement(dropdown_1.Dropdown, { value: element.eventType, onChange: this.changeEventType(element.id) },
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'default' }, this.props.translate('packages.BPMN.BPMNEndEvent')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'message' }, this.props.translate('packages.BPMN.BPMNMessageEndEvent')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'escalation' }, this.props.translate('packages.BPMN.BPMNEscalationEndEvent')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'error' }, this.props.translate('packages.BPMN.BPMNErrorEndEvent')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'compensation' }, this.props.translate('packages.BPMN.BPMNCompensationEndEvent')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'signal' }, this.props.translate('packages.BPMN.BPMNSignalEndEvent')),
                    react_1.default.createElement(dropdown_1.Dropdown.Item, { value: 'terminate' }, this.props.translate('packages.BPMN.BPMNTerminateEndEvent'))))));
    };
    return BPMNEndEventUpdateComponent;
}(react_1.Component));
exports.BPMNEndEventUpdate = enhance(BPMNEndEventUpdateComponent);
