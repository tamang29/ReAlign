...
`;
class BPMNStartEventUpdateComponent extends Component {
    constructor() {
        super(...arguments);
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("section", null,
                ...
                React.createElement(Dropdown, { value: element.eventType, onChange: this.changeEventType(element.id) },
                    React.createElement(Dropdown.Item, { value: 'default' }, this.props.translate('packages.BPMN.BPMNStartEvent')),
                    React.createElement(Dropdown.Item, { value: 'message' }, this.props.translate('packages.BPMN.BPMNMessageStartEvent')),
                    React.createElement(Dropdown.Item, { value: 'timer' }, this.props.translate('packages.BPMN.BPMNTimerStartEvent')),
                    React.createElement(Dropdown.Item, { value: 'conditional' }, this.props.translate('packages.BPMN.BPMNConditionalStartEvent')),
                    React.createElement(Dropdown.Item, { value: 'signal' }, this.props.translate('packages.BPMN.BPMNSignalStartEvent'))))));
    }
}
