...
export const UMLActivityControlFlowComponent = ({ element }) => {
    ...
    return (React.createElement("g", null,
        ...
        React.createElement("text", { x: position.x, y: position.y, ...layoutText(direction), pointerEvents: "none", style: { ...fill } }, element.name)));
};
//# sourceMappingURL=uml-activity-control-flow-component.js.map