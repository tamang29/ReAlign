 ...
 *
 */
export declare function inclusionMapToArray(map: Record<string, boolean>): string[];
/**
 *
 ...
 *
 */
export declare function arrayToInclusionMap(array: string[]): Record<string, boolean>;
