import { isCommunicationLink } from './typings';
/**
 *
 ...
 */
export function v2RelationshipToV3Relationship(relationship) {
 ...
 */
export function v3RelaionshipToV2Relationship(relationship) {
    if (isCommunicationLink(relationship)) {
        return {
            ...relationship,
 ...
 *
 */
export function v2ModeltoV3Model(model) {
