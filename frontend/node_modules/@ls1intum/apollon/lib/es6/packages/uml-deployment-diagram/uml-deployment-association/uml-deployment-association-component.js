...
export const UMLDeploymentAssociationComponent = ({ element }) => {
    ...
    return (React.createElement("g", null,
        ...
        React.createElement(Text, { fill: element.textColor, x: position.x, y: position.y, ...layoutText(direction), pointerEvents: "none" }, element.name)));
};
