...
`;
class ActivityControlFlowUpdate extends Component {
    constructor() {
        super(...arguments);
        ...
        return (React.createElement("div", null,
            React.createElement("section", null,
                React.createElement(Flex, null,
                    React.createElement(Header, { gutter: false, style: { flexGrow: 1 } }, this.props.translate('packages.ActivityDiagram.ActivityControlFlow')),
